...
<main id="store_list_under">
    ...
    <div class="store_fun_jump">
        <a href="" class="store_info_btn"><i class="fa-solid fa-circle-chevron-down"></i> 東部へ</a>
        <a href=".area_cate" class="store_info_btn"><i class="fa-solid fa-circle-chevron-down"></i> 西部へ</a>
        <a href=".area_cate" class="store_info_btn"><i class="fa-solid fa-circle-chevron-down"></i> 南部へ</a>
    </div>
    <?php
